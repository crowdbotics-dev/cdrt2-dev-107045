...
export const api_v1_sffgg_list = createAsyncThunk(
  "sffggs/api_v1_sffgg_list",
  async payload => {
    const response = await apiService.api_v1_sffgg_list(payload)
    return response.data
  }
)
export const api_v1_sffgg_create = createAsyncThunk(
  "sffggs/api_v1_sffgg_create",
  async payload => {
    const response = await apiService.api_v1_sffgg_create(payload)
    return response.data
  }
)
export const api_v1_sffgg_retrieve = createAsyncThunk(
  "sffggs/api_v1_sffgg_retrieve",
  async payload => {
    const response = await apiService.api_v1_sffgg_retrieve(payload)
    return response.data
  }
)
export const api_v1_sffgg_update = createAsyncThunk(
  "sffggs/api_v1_sffgg_update",
  async payload => {
    const response = await apiService.api_v1_sffgg_update(payload)
    return response.data
  }
)
export const api_v1_sffgg_partial_update = createAsyncThunk(
  "sffggs/api_v1_sffgg_partial_update",
  async payload => {
    const response = await apiService.api_v1_sffgg_partial_update(payload)
    return response.data
  }
)
export const api_v1_sffgg_destroy = createAsyncThunk(
  "sffggs/api_v1_sffgg_destroy",
  async payload => {
...
const sffggsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_sffgg_list.pending, (state, action) => {
