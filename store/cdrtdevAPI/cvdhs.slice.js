...
export const api_v1_cvdh_list = createAsyncThunk(
  "cvdhs/api_v1_cvdh_list",
  async payload => {
    const response = await apiService.api_v1_cvdh_list(payload)
    return response.data
  }
)
export const api_v1_cvdh_create = createAsyncThunk(
  "cvdhs/api_v1_cvdh_create",
  async payload => {
    const response = await apiService.api_v1_cvdh_create(payload)
    return response.data
  }
)
export const api_v1_cvdh_retrieve = createAsyncThunk(
  "cvdhs/api_v1_cvdh_retrieve",
  async payload => {
    const response = await apiService.api_v1_cvdh_retrieve(payload)
    return response.data
  }
)
export const api_v1_cvdh_update = createAsyncThunk(
  "cvdhs/api_v1_cvdh_update",
  async payload => {
    const response = await apiService.api_v1_cvdh_update(payload)
    return response.data
  }
)
export const api_v1_cvdh_partial_update = createAsyncThunk(
  "cvdhs/api_v1_cvdh_partial_update",
  async payload => {
    const response = await apiService.api_v1_cvdh_partial_update(payload)
    return response.data
  }
)
export const api_v1_cvdh_destroy = createAsyncThunk(
  "cvdhs/api_v1_cvdh_destroy",
  async payload => {
...
const cvdhsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_cvdh_list.pending, (state, action) => {
